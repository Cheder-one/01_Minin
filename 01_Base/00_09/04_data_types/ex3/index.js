...
console.log('"Переменную const переопределить нельзя"', bestProgrammingLanguage1, typeof bestProgrammingLanguage1, bestProgrammingLanguage2, typeof bestProgrammingLanguage2);
